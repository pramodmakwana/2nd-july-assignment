...
person = Person("john mathew", 22)
person.display_info()
print()
employee = Employee("Rohan shah", 25, 1234)
...
my_car = Car("Nisan", "nexa", 2023, "Disel")
my_car.display_info()
...
manager = Manager("raj singh", 80000, "new")
manager.display_info()

print()

developer = Developer("raj saha", 60000, "java")
...
phone = Phone("redmi", "note 12", "6.3inches")
phone.display_info()

print()

tablet = Tablet("nokia", "lumina", "6000 mAh")
tablet.display_info()
...
savings_account = SavingsAccount("71419071610", 4000)
savings_account.display_info()
print()
savings_account.calculate_interest(7)
savings_account.display_info()
print()
checking_account = CheckingAccount("97070170", 50000)
